"""
Django settings for azureback project.
...
ALLOWED_HOSTS = ["127.0.0.1","'localhost","testserver","bb09-2804-828-f230-656a-3dd9-7c85-352c-eec1.ngrok-free.app"]
...
WSGI_APPLICATION = 'azureback.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv("DJANGO_PASSWORD"),
