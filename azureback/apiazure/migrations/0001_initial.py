# Generated by Django 4.2.16 on 2025-02-20 03:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('scale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiazure.horary')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='waitvoluntary', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notiys', models.ManyToManyField(to='apiazure.notify')),
